...
- `@deepseek-ai/dsh-client-connection-ipc`（[`packages/client/connection-ipc/src/index.ts`](../packages/client/connection-ipc/src/index.ts)）
...
- `@deepseek-ai/dsh-desktop-app` — requires `desktopApp`（[`packages/bundle/desktop-app/src/index.ts`](../packages/bundle/desktop-app/src/index.ts)）
...
- `@deepseek-ai/dsh-client-connection-core`（[`packages/client/connection-core/src/index.ts`](../packages/client/connection-core/src/index.ts)）
