...
This guide assumes you started the Web UI through the [root README](../../../README.md#web-ui-via-cli). Model changes take effect on the next request without restarting the server.
