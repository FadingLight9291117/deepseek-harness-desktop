...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    summary: 'Native window color-scheme sync the desktop app provides under Electron.',
    description: 'Native window color-scheme sync the desktop app provides under Electron. The theme preference arrives schema-validated from the settings service; \'system\' keeps the OS\'s own appearance tracking intact.',
    methods: [
      {
        signature: 'setThemePreference(preference: ThemePreference): void',
        description: 'Apply the app\'s theme preference to the native window chrome.',
        parameters: [{ name: 'preference', description: 'the persisted Light/Dark/System preference.' }],
      },
    ],
  },
  {
